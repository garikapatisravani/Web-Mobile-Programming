...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendNotification(View view) {
        ...
        builder.setContentText("This is the final ICP of Web Mobile Programming Course");
        builder.setStyle(new NotificationCompat.BigTextStyle().bigText("This is the final ICP of Web Mobile Programming Course"));
