...
public class MainActivity extends AppCompatActivity {
    ...
    private void recognition(String text){ // Recognize speaking
        ...
        else if(text.contains("what medicines should I take")){ // user will ask this
            speak(preferences.getString(NAME, null) + ", I think you have a Fever. Please take this medicine.");// speaker answer
        }
        else if(text.contains("I am not feeling well what should I do")){// user will ask this
            speak("I can understand. Please tell your symptoms in short.");// speaker answer
        }

        else if(text.contains("thank you my medical assistant")){// user will ask this
            speak("Thank you too" + preferences.getString(NAME, null) + "Take care");//speaker answer
        }
        else if(text.contains("what time is it")) {// Time asking
